...
class CompanyModel {
	...
	public static function getOffers($user_id = null) {
		...
		$database = DatabaseFactory::getFactory()->getConnection();
		if (empty($user_id)) {
			$sql = "SELECT a.offer_id, a.local_type, a.user_id, a.title, a.city, a.address, a.sector, a.costos, b.name, b.lastname, b.email, b.document, b.city, b.phone, b.avatar, b.bio FROM TB_OFFERS a INNER JOIN TB_USERS b ON a.user_id = b.user_id";
		} else {
			$sql = "SELECT a.offer_id, a.local_type, a.user_id, a.title, a.city, a.address, a.sector, a.costos, b.name, b.lastname, b.email, b.document, b.city, b.phone, b.avatar, b.bio FROM TB_OFFERS a INNER JOIN TB_USERS b ON a.user_id = b.user_id WHERE a.user_id = :user_id";
		}
		$query = $database->prepare($sql);
