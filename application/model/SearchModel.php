...
class SearchModel {
	...
	private static function countSearchOffer($user_id = null, $keyword = null, $local_type = null, $start_date = null, $end_date = null, $city = null, $careers = null, $workareas = null, $benefits = null) {

		$sql = "SELECT DISTINCT a.offer_id, a.local_type, a.title as offer_title, a.user_id, a.end_date, from_unixtime(a.end_date, '%d-%m-%Y') as end, a.city, a.description, from_unixtime(a.publication_date, '%d-%m-%Y') as publication, a.publication_date, from_unixtime(a.close_date, '%d-%m-%Y') as close, a.close_date, b.name as user_name, b.lastname as user_lastname, b.email, b.avatar FROM TB_OFFERS a INNER JOIN TB_USERS b ON b.user_id = a.user_id";
		$values = array();
...
*/
		...
		if (!empty($local_type)) {
			$sql = $sql . "AND a.local_type = :local_type";
			$values[':local_type'] = $local_type;
		}
...
*/
	...
	public static function searchOffer() {
		...
		$local_type = Request::post('local_type');
		...
		$total = self::countSearchOffer($user_id, $keyword, $local_type, $start_date, $end_date, $city, $careers, $workareas, $benefits);
...
*/
	...
	public static function recentOffers() {
		$database = DatabaseFactory::getFactory()->getConnection();
		$sql = "SELECT a.offer_id, a.local_type, a.user_id, a.title, a.city,a.sector,a.address,a.costos, b.name, b.lastname, b.email, b.avatar FROM TB_OFFERS a INNER JOIN TB_USERS b ON a.user_id = b.user_id LIMIT 10";
		$query = $database->prepare($sql);
		$query->execute();
	...
	private static function countSearchApplications($student_id, $keyword = null, $local_type = null, $start_date = null, $end_date = null, $city = null) {
		...
		if (!empty($local_type)) {
			$sql = $sql . " AND b.local_type = :local_type";
			$values[':local_type'] = $local_type;
		}
	...
	public static function searchApplications() {
		...
		$city = Request::post('city');
		$page = empty(Request::post('page')) ? 1 : Request::post('page');
		$total = self::countSearchApplications($student_id, $keyword, $local_type, $start_date, $end_date, $city);
