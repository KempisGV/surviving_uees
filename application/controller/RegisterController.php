...
class RegisterController extends Controller {
    ...
    public function request_action() {
		...
		$result = RegistrationModel::registerNewRequest ( Request::post('name'), Request::post('lastname'), Request::post('email'), Request::post('document'), Request::post('city'), Request::post('phone'));
