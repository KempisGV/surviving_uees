...
class OfferController extends Controller {
	...
	public function addOffer_action() {
		...
		$result = OfferModel::addOffer(Request::post('local_type'), Request::post('title'), Request::post('city'), Request::post('sector'), Request::post('address'), Request::post('costos') );
	...
	public function editOffer_action() {
		...
		$result = OfferModel::editOffer(Request::post('offer_id'), Request::post('local_type'), Request::post('title'), Request::post('end_date'), Request::post('city'), Request::post('careers'), Request::post('workareas'), Request::post('benefits'), Request::post('description'));
