						...
						<div class="noo-main col-md-12">
							<div class="account-form show-login-form-links">
								<div class="account-log-form">
									<form class="form-horizontal" action="<?php echo Config::get('URL'); ?>login/resetPassword_action" method="post">
										<?php $this->renderfeedbackMessages(); ?>
										<input type="hidden" name="csrf_token" value="<?php echo Csrf::makeToken(); ?>" />
										<input type="hidden" name="user_id" value="<?php echo $this->user_id; ?>" />
										<input type="hidden" name="password_reset_hash" value="<?php echo $this->code; ?>" />
