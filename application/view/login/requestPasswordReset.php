...
<html lang="en-US">
	<head>
		...
		<title>Reiniciar Contraseña | SURVIVING UEES</title>
			...
			<div class="noo-page-heading">
 				<div class="container-boxed max text-center parallax-content">
					<div class="page-heading-info ">
						<h1 class="page-title">REINICIAR CONTRASEÑA</h1>
					</div>
					<div class="page-sub-heading-info">
						Ingresa tu correo para enviarte el link de reinicio de contraseña
					</div>
				</div>
						...
						<div class="noo-main col-md-12">
							<div class="account-form show-login-form-links">
								<div class="account-log-form">
									<form class="form-horizontal" action="<?php echo Config::get('URL'); ?>login/requestPasswordReset_action" method="post">
