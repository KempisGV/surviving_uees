...
<html lang="en-US">
	<head>
		...
		<title>Inicio de Sesión | SURVIVING UEES</title>
									...
									<form class="form-horizontal" action="<?= Config::get('URL'); ?>login/login_action" method="post">
										...
										<div class="form-actions form-group text-center">
											...
											<div class="login-form-links">
												...
												<span>Eres un dueño de local y quieres registrarte? Llena la solicitud <a href="<?= Config::get('URL'); ?>register/request" class="member-links member-register-link">aquí</a></span>
											</div>
										</div>
									</form>
								</div>
