...
<html lang="en-US">
	<head>
		...
		<title>Perfil <?= $this->university->name; ?> | SURVIVING UEES</title>
		...
		<div class="site">
			...
			<div class="noo-page-heading">
				<div class="container-boxed max parallax-content">
					<div class="page-heading-info">
						<h1 class="page-title"><?= $this->university->name; ?></h1>
					</div>
				</div>
			...
			<div class="container-wrap">
				<div class="container-boxed max offset main-content single-noo_job">
					<div class="row">
						<div class="col-xs-12 mb-2"><a href="<?= COnfig::get('URL'); ?>public/universities">Volver a Directorio</a></div>
								...
								<div class="company-desc">
									<div class="company-header">
										<div class="company-featured">
											<a href="#">
												<img width="110" height="110" src="<?= Config::get('URL') . 'images/avatar/' . $this->university->avatar; ?>" alt="<?= $this->university->name; ?>"/>
											</a>
										</div>
										<h3 class="company-title">
											<a href="#"><?= $this->university->name; ?></a>
										</h3>
									</div>
									<div class="company-info">
										...
										<div class="job-social clearfix">
											...
											<div class="mb-2"><a href="<?= Config::get('URL') . 'files/' . $deal->file_name; ?>" target="_blank"><?= $deal->company_name; ?></a></div>
											<?php } ?>
										</div>
									</div>
								</div>
