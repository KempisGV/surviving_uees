			...
			<div class="container-boxed max">
				...
				<nav class="collapse navbar-collapse noo-user-navbar-collapse">
					<ul class="navbar-nav sf-menu">
						...
						<li>
							<a href="<?= Config::get('URL'); ?>offer/addoffer"><i class="fa fa-pencil-square-o"></i> Registrar local</a>
						</li>
						<li>
							<a href="<?= Config::get('URL'); ?>offer/myoffers"><i class="fa fa-briefcase"></i> Mis locales</a>
						</li>
				...
				<nav class="collapse navbar-collapse noo-navbar-collapse">
					<ul class="navbar-nav sf-menu">
						...
						<li class="align-left">
							<a href="<?= Config::get('URL'); ?>offer">Locales</a>
						</li>
						<?php if (Session::get('user_logged_in')) { ?>
						<li class="nav-item-member-profile login-link align-right">
							...
							<ul class="sub-menu">
								...
								<?php if (Session::get('user_account_type') == 1) { ?>
								<?php } elseif (Session::get('user_account_type') == 2) { ?>
								<li><a href="<?= Config::get('URL'); ?>offer/addoffer"><i class="fa fa-pencil-square-o"></i> Registrar local</a></li>
								<li><a href="<?= Config::get('URL'); ?>offer/myoffers"><i class="fa fa-briefcase"></i> Mis locales</a></li>
								<?php } elseif (Session::get('user_account_type') == 4) { ?>
