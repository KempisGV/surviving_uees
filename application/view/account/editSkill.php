...
<html lang="en-US">
	<head>
		...
		<title>Editar Habilidad | SURVIVING UEES</title>
			...
			<div class="noo-page-heading">
				<div class="container-boxed max text-center parallax-content">
					<div class="member-heading-avatar">
						...
						<h1 class="page-title">Editar Habilidad</h1>
					</div>
					</div>
				</div>
				...
				<div class="main-content container-boxed max offset">
					<div class="row">
						<div class="noo-main col-md-12">
							<form class="form-horizontal" action="<?= Config::get('URL'); ?>account/editSkill_action" method="post">
								<input type="hidden" name="csrf_token" value="<?= Csrf::makeToken(); ?>">
								<input type="hidden" name="skill_id" value="<?= $this->skill_id; ?>">
								<div class="candidate-profile-form row">
									<div class="col-sm-12">
										<?php $this->renderfeedbackMessages(); ?>
										<div class="form-group">
											<label for="name" class="col-sm-4 control-label">Nombre Habilidad</label>
											<div class="col-sm-8">
										    	<input type="text" class="form-control" id="name" value="<?= $this->name; ?>" name="name" placeholder="Nombre Habilidad">
										    </div>
										</div>
										<div class="form-group">
											<label for="rating" class="col-sm-4 control-label">Porcentaje Conocimiento</label>
											<div class="col-sm-8">
										    	<input type="text" class="form-control" id="rating" value="<?= $this->rating; ?>" name="rating" placeholder="1 al 100">
										    </div>
										</div>
									</div>
								</div>
								<div class="form-group text-center">
									...
									<a class="btn btn-default" href="<?= Config::get('URL') . 'account/deleteskill/' . $this->skill_id ?>">Borrar Habilidad</a>
								</div>
