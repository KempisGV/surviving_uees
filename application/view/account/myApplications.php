...
<html lang="en-US">
	<head>
		...
		<title>Mis Postulaciones | Internship Finder</title>
	...
	<body>
							...
							<div class="noo-sidebar-wrap">
								<div class="widget widget_noo_advanced_search_widget">
									...
									<form class="widget-advanced-search" id="search-form" action="<?= Config::get('URL'); ?>offer/search" method="post">
										<input type="hidden" name="student_id" id="student_id" value="<?= Session::get('user_id'); ?>">
		...
		<script type="text/javascript" src="<?php echo Config::get('URL'); ?>js/main3.js"></script>
