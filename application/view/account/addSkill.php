...
<html lang="en-US">
	<head>
		...
		<title>Agregar Habilidad | SURVIVING UEES</title>
			...
			<div class="noo-page-heading">
				<div class="container-boxed max text-center parallax-content">
					<div class="member-heading-avatar">
						...
						<h1 class="page-title">Agregar Habilidad</h1>
					</div>
					</div>
				</div>
				...
				<div class="main-content container-boxed max offset">
					<div class="row">
						<div class="noo-main col-md-12">
							<form class="form-horizontal" action="<?= Config::get('URL'); ?>account/addSkill_action" method="post">
