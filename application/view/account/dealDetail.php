...
<html lang="en-US">
	<head>
		...
		<title>Detalle Convenio | SURVIVING UEES</title>
			...
			<div class="noo-page-heading">
				<div class="container-boxed max parallax-content">
					<div class="page-heading-info">
						<h1 class="page-title">Detalle Convenio</h1>
					</div>
				</div>
				...
				<div class="container-boxed max offset main-content single-noo_job">
					<div class="row">
						...
						<div class="noo-main col-md-8">
							<div class="job-desc">
								<h3>Universidad</h3>
								<p><?= $this->university_name; ?></p>
								<h3>Tipo de Convenio</h3>
								<p><?= $this->deal_type == 1 ? 'Práctica Pre Profesional' : 'Proyecto de Vinculación'; ?></p>
								<h3>Fecha Inicio</h3>
								<p><?= date('d-m-Y', $this->start_date); ?></p>
								<h3>Duración</h3>
								<p><?= $this->duration; ?> años</p>
								<h3>Contacto Compañía</h3>
								<p><?= $this->contact_person; ?></p>
								<p><?= $this->contact_mail; ?></p>
								<h3>Contacto Universidad</h3>
								<p><?= $this->university_person; ?></p>
								<p><?= $this->university_mail; ?></p>
								<h3>Extensión del Convenio</h3>
								<p><?= $this->deal_extent == 1 ? 'Marco' : 'Proyecto Específico' ?></p>
								<h3>Auto Renovable</h3>
								<p><?= $this->deal_autorenewable ? 'Sí' : 'No'; ?></p>
							</div>
							<div class="job-action">
								<?php if (!empty($this->filename)) { ?>
								<a class="btn btn-primary" href="">Ver Documento</a>
								<?php } ?>
							</div>
						</div>
