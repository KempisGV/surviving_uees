...
<html lang="en-US">
	<head>
		...
		<title>Perfil Estudiante | SURVIVING UEES</title>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="resume-desc">
												...
												<a class="btn btn-primary" href="<?= Config::get('URL'); ?>account/selectedapplicants">Volver a Postulantes Seleccionados</a>
											</div>
										</div>
									</div>
								</div>
