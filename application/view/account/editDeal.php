...
<html lang="en-US">
	<head>
		...
		<title>Editar Convenio | SURVIVING UEES</title>
			...
			<div class="noo-page-heading">
				<div class="container-boxed max text-center parallax-content">
					<div class="member-heading-avatar">
						...
						<h1 class="page-title">Editar Convenio</h1>
					</div>
					</div>
				</div>
				...
				<div class="main-content container-boxed max offset">
					<div class="row">
						<div class="noo-main col-md-12">
							<form class="form-horizontal" enctype="multipart/form-data" action="<?= Config::get('URL'); ?>account/editDeal_action" method="post">
								<input type="hidden" name="csrf_token" value="<?= Csrf::makeToken(); ?>">
								<input type="hidden" name="deal_id" value="<?= $this->deal->deal_id; ?>">
								<div class="candidate-profile-form row">
									<div class="col-sm-12">
										<?php $this->renderfeedbackMessages(); ?>
										<div class="form-group">
											<label for="school_name" class="col-sm-4 control-label">Compañía</label>
											<div class="col-sm-8">
										    	<select type="text" class="form-control" id="company_id" name="company_id">
											    	...
											    	<option value="<?= $company->user_id; ?>" <?php if ($this->deal->company_id == $company->user_id) { echo "selected"; } ?>><?= $company->name; ?></option>
											    	<?php } ?>
										    	</select>
										    </div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
										    	<select type="text" class="form-control" id="deal_type" name="deal_type">
											    	...
											    	<option value="1" <?php if ($this->deal->deal_type == 1) { echo "selected"; } ?>>Práctica Pre-Profesional</option>
											    	<option value="2" <?php if ($this->deal->deal_type == 2) { echo "selected"; } ?>>Proyecto de Vinculación</option>
										    	</select>
										    </div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
										    	<input type="text" class="form-control" id="start_date" value="<?= date('d-m-Y', $this->deal->start_date); ?>" name="start_date" placeholder="Fecha Inicio" readonly>
										    </div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
										    	<select type="text" class="form-control" id="duration" name="duration">
											    	...
											    	<option value="1" <?php if ($this->deal->duration == 1) { echo "selected"; } ?>>1 año</option>
											    	<option value="2" <?php if ($this->deal->duration == 2) { echo "selected"; } ?>>2 años</option>
											    	<option value="2" <?php if ($this->deal->duration == 3) { echo "selected"; } ?>>3 años</option>
											    	<option value="2" <?php if ($this->deal->duration == 4) { echo "selected"; } ?>>4 años</option>
											    	<option value="2" <?php if ($this->deal->duration == 5) { echo "selected"; } ?>>5 años</option>
										    	</select>
										    </div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" name="contact_person" id="contact_person" placeholder="Nombre Contacto Compañía" value="<?= $this->deal->contact_person; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="contact_mail" class="col-sm-4 control-label">Correo Contacto Compañía</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" name="contact_mail" id="contact_mail" placeholder="Correo Contacto Compañía" value="<?= $this->deal->contact_mail; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="university_person" class="col-sm-4 control-label">Nombre Contacto Universidad</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" name="university_person" id="university_person" placeholder="Nombre Contacto Universidad" value="<?= $this->deal->university_person; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="university_mail" class="col-sm-4 control-label">Correo Contacto Universidad</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" name="university_mail" id="university_mail" placeholder="Correo Contacto Universidad" value="<?= $this->deal->university_mail; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
										    	<select type="text" class="form-control" id="deal_extent" name="deal_extent">
											    	...
											    	<option value="1" <?php if ($this->deal->deal_extent == 1) { echo "selected"; } ?>>Marco</option>
											    	<option value="2" <?php if ($this->deal->deal_extent == 2) { echo "selected"; } ?>>Específico</option>
										    	</select>
										    </div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-8">
												<label for="deal_autorenewable_yes" style="margin-right: 15px;">
													<input type="radio" name="deal_autorenewable" id="deal_autorenewable_yes" value="1" <?= $this->deal->deal_autorenewable ? 'checked' : ''; ?>> Si
												</label>
												<label for="deal_autorenewable_no">
													<input type="radio" name="deal_autorenewable" id="deal_autorenewable_no" value="0" <?= !$this->deal->deal_autorenewable ? 'checked' : ''; ?>> No
												</label>
											</div>
										</div>
										<div class="form-group">
								...
								<div class="form-group text-center">
									...
									<a class="btn btn-default" href="<?= Config::get('URL') . 'account/deleteDeal/' . $this->deal->deal_id; ?>">Borrar Convenio</a>
								</div>
